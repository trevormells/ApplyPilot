...
def status() -> None:
    ...
    from applypilot.status_dashboard import render_status_dashboard

    min_score = int(DEFAULTS["min_score"])
    stats = get_stats(min_score=min_score)
    console.print()
    console.print(render_status_dashboard(stats, min_score=min_score))
    console.print()
